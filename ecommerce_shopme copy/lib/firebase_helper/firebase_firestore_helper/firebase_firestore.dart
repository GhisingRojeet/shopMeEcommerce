...
class FirebaseFirestoreHelper {
  ...
  Future<bool> uploadOrderedProductFirebase(
    ...
    try {
      ...
      //         // FirebaseFirestore.instance.collection("categories").doc("products").set("qty": qty- model.qty .where("id"))

        
      // }

    //    if(
    //   qty>=completedOrderQuantity
    // ){
    //   qty-=completedOrderQuantity;
    //   FirebaseFirestore.instance.collection("categories").doc('products').update({'qty':qty}).then((value){
    // //     notifyListeners();
    //   }).catchError((error){
  ...
  //      double qty= 0;
  // // void decreaseTotalQuantity(int completedOrderQuantity ){
  // //  
